...
const AREAS = [
  { id:'jongno', name:'鐘路 / 北村', spots:[
    ...
    { n:'昌德宮後苑', tag:'古蹟', d:'需預約導覽的祕苑,韓國唯一列入世界遺產的宮殿。', hours:'09:00–17:30(週一公休,後苑需預約導覽場次)', mapQuery:'Changdeokgung Palace Seoul', site:'https://www.cdg.go.kr' },
  ...
  { id:'myeongdong', name:'明洞', spots:[
    ...
    { n:'南山首爾塔', tag:'夜景', d:'搭纜車上南山,情人鎖牆是必訪拍照點。', hours:'10:00–23:00(展望台,末班纜車提早)', mapQuery:'N Seoul Tower', site:'https://www.nseoultower.co.kr' },
    { n:'明洞聖堂', tag:'建築', d:'首爾最早的哥德式教堂建築之一,鬧區中的靜謐角落。', hours:'06:00–21:00(彌撒時間不開放參觀)', mapQuery:'Myeongdong Cathedral Seoul', site:'https://mdsd.or.kr' }
  ]},
