...
const AREAS = [
  ...
  { id:'sinsa', name:'新沙洞林蔭道', spots:[
    ...
    { n:'Milestone Coffee 新沙店', tag:'咖啡', d:'推薦:維也納咖啡跟甜點提拉米蘇。', hours:'10:00–20:00；四五休息', mapQuery:'마일스톤 커피 신사' },
    { n:'SAPPUN 新沙林蔭大道', tag:'女鞋', d:'人氣平價女鞋品牌，結合法式優雅與寬敞空間的品牌旗艦店。價格親民，平均約5萬至6萬韓元', hours:'週一至週日 11:00 – 21:00', mapQuery:'사뿐 가로수길 플래그십스토어 (SAPPUN)', site:'https://www.sappun.co.kr/?srsltid=AU7gw4U8I8lM7BEtFGvvdtBV3bjkFIcHz-fAadRc6bAgHNLu_rAQqGQU'   },
...
const PACKING = [
  { category:'證件與金錢', items:['護照(效期6個月以上)','護照影本 / 電子檔備份','身分證', '健保卡','機票、住宿訂單','錢包','韓幣現金','信用卡(記得開通海外交易)','旅遊保險證明'] },
  { category:'電子用品', items:['手機','行動電源','充電頭', '充電線', '相機','記憶卡', '電池', '腳架', '運動相機','轉接頭(韓國為 220V)','SIM卡 / Wi-Fi 分享器'] },
  { category:'衣物', items:['依天數準備的上衣、褲子','保暖外套(依季節)','舒適好走的鞋子','襪子、內衣褲','睡衣'] },
  { category:'保養與盥洗', items:['防曬乳','防曬','防蚊液','指甲刀','濕紙巾', '衛生紙', '衛生棉', '酒精','面膜','個人保養品(小罐分裝)','牙刷牙膏','化妝品 / 卸妝用品','牙線棒','棉花棒', '隱形眼鏡 / 眼鏡'] },
  { category:'藥品', items:['個人常備藥','暈車藥','腸胃藥','酸痛貼布','個人處方藥(建議附英文診斷書)'] },
  { category:'其他', items:['環保購物袋(逛市場好用)', '塑膠袋', '夾鏈袋', '雨傘或雨衣','行李秤','轉換插座延長線','筆記本或旅遊清單'] }
];

/* ---------------- Restaurant menus (Korean-Chinese pairs) ---------------- */
const MENUS = {
  '廣藏市場綠豆煎餅': [
    { ko:'녹두빈대떡', zh:'綠豆煎餅' },
    { ko:'막걸리', zh:'馬格利酒' },
  ...
  '倫敦貝果 London Bagel Museum(安國店)': [
    { ko:'대파 크림치즈 베이글', zh:'蔥乳酪貝果' },
    { ko:'플레인 베이글', zh:'原味貝果' }
  ],
  'Cafe Onion 安國店': [
    { ko:'설산빵', zh:'雪山麵包' },
  ...
  '豬腳小姐 Myth Jokbal(弘大總店)': [
    { ko:'마늘 족발', zh:'蒜味豬腳' },
    { ko:'칼국수', zh:'刀削麵湯底' }
  ],
  'BHC 炸雞(外送)': [
    { ko:'뿌링클', zh:'香蒜起司炸雞(招牌口味)' },
    { ko:'후라이드', zh:'原味炸雞' }
  ],
  'Goobne 炸雞(外送)': [
    { ko:'오리지널 후라이드', zh:'原味烤雞' },
    { ko:'양념', zh:'醬燒烤雞' }
  ]
};
...
const DINING_PHRASES = [
  { ko:'이거 주세요', zh:'請給我這個' },
  { ko:'하나 더 주세요', zh:'請再給我一份' },
  { ko:'맵지 않게 해주세요', zh:'請幫我不要辣' },
  { ko:'물 좀 주세요', zh:'請給我水' },
  { ko:'여기요!', zh:'這裡!(呼叫服務生)' },
  { ko:'계산해주세요', zh:'請幫我結帳' },
  { ko:'포장해주세요', zh:'請幫我打包外帶' },
  { ko:'영수증 주세요', zh:'請給我收據' },
  { ko:'잘 먹겠습니다', zh:'我要開動了' },
  { ko:'맛있어요', zh:'很好吃' }
];
...
const SEED_PLAN = {
  1: [
    ...
    { name:'新沙洞林蔭道:旗艦店逛街與咖啡', start:'17:00', end:'18:00' },
    { name:'晚餐:Dongnyeok（동녘）', start:'18:00', end:'19:30' },
    { name:'解放村:新興市場夜景小酌', start:'19:30', end:'20:30' },
    { name:'盤浦漢江公園:夜景與外送炸雞', start:'20:30', end:'22:00' }
  ],
  2: [
