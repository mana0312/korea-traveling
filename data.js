...
const AREAS = [
  { id:'jongno', name:'鐘路 / 北村', spots:[
    { n:'景福宮', tag:'古宮', d:'朝鮮王朝正宮,每日兩場守衛交接儀式,建議租借韓服可免門票。', hours:'09:00–18:00(週二公休,依季節調整閉館時間)', mapQuery:'Gyeongbokgung Palace Seoul', site:'https://royal.khs.go.kr/ROYAL/contents/menuInfo-gbg.do?grpCode=gbg' },
    { n:'北村韓屋村', tag:'散步', d:'保存完整的傳統韓屋巷弄,清晨人少最適合拍照。', hours:'全天開放(部分為住宅區,請放低音量)', mapQuery:'Bukchon Hanok Village Seoul', site:'https://hanok.seoul.go.kr/front/hanokWeekMotion.do' },
  ...
  { id:'myeongdong', name:'明洞', spots:[
    ...
    { n:'韓國麗芬聚國際皮膚科 明洞國際旗艦店', tag:'皮膚科診所', d:'韓國知名的連鎖輕奢醫美皮膚科品牌,中韓價格統一，官網與現場標價清楚，提供現場中文翻譯及專屬線上客服（如 Line、微信）。', hours:'10:00–19:00', mapQuery:'PPEUM Global Clinic Myeongdong', site:'https://global.ppeum16.com/?lan=global_eng&mode=mo' }
  ]},
  ...
  { id:'seongsu', name:'聖水洞', spots:[
    ...
    { n:'Onion 聖水店', tag:'咖啡', d:'廢墟工業風改建的人氣麵包咖啡廳,聖水洞地標之一。', hours:'07:00–22:00(依店家公告調整)', mapQuery:'Onion Cafe Seongsu Seoul', site:'https://onion.rest' },
    { n:'Nudake Seongsu', tag:'咖啡', d:'前衛藝術系甜點咖啡廳,以造型甜點與空間設計聞名。', hours:'11:00–20:00(依官方公告調整)', mapQuery:'Nudake Seongsu Seoul', site:'https://nudake.com' },
  ...
  { id:'cheonggyecheon', name:'清溪川', spots:[
    { n:'清溪川(廣橋至光化門段)', tag:'散步', d:'市中心的親水步道,沿岸有燈飾造景,適合晚餐後散步。', hours:'24小時開放,建議夜間散步欣賞燈光', mapQuery:'Cheonggyecheon Stream Seoul', site:'https://cheonggye.seoul.go.kr' }
  ]},
  { id:'hongdae', name:'弘大', spots:[
    ...
    { n:'Olive Young 弘大總店', tag:'購物', d:'韓國最大美妝連鎖店的弘大旗艦店,品項齊全常有優惠。', hours:'10:00–24:00', mapQuery:'Olive Young Hongdae Main Store Seoul', site:'https://www.oliveyoung.co.kr' },
    { n:'AK+ 購物中心', tag:'購物', d:'弘大商圈的複合式購物中心,集結流行服飾與生活選品。', hours:'10:30–22:00', mapQuery:'AK Hongdae Seoul', site:'https://www.akplaza.com' },
    { n:'Chuu 弘大店', tag:'購物', d:'韓國人氣少女風服飾品牌直營店。', hours:'11:00–22:00(依官方公告調整)', mapQuery:'Chuu Hongdae Seoul', site:'https://www.chuu.co.kr' },
    { n:'WITHMUU 弘大 AK+ 店(위드뮤)', tag:'K-POP周邊', d:'位於 AK+ 購物中心2樓(弘大入口站4號出口直通大樓),目前首爾規模最大、商品最齊全的官方 K-POP 周邊與手燈專賣店之一,熱門團體(TWICE、SEVENTEEN、Stray Kids、IVE、NCT、NewJeans 等)官方手燈通常都有現貨,可現場購買電池與測試燈光。', hours:'依 AK+ 購物中心營業時間為準,建議出發前再確認', mapQuery:'위드뮤 홍대 AK플라자' },
    { n:'BEATROAD 弘大店(비트로드)', tag:'K-POP周邊', d:'弘大街頭主幹道巷弄內的知名 K-POP 專輯與官方周邊店,手燈品項齊全,價格標示清晰。', hours:'依店家公告為準,建議出發前再確認', mapQuery:'비트로드 홍대' },
    { n:'MUSIC PLANT 弘大店(뮤직플랜트)', tag:'K-POP周邊', d:'弘大商圈巷弄內的專輯與周邊店,除了專輯外設有專門的手燈與周邊展示區。', hours:'依店家公告為準,建議出發前再確認', mapQuery:'뮤직플랜트 홍대' }
  ]},
  { id:'gangnam', name:'江南', spots:[
    { n:'蠶室樂天世界塔', tag:'展望台', d:'首爾最高建築,123樓展望台可俯瞰漢江全景。', hours:'10:30–22:00(展望台 Seoul Sky)', mapQuery:'Lotte World Tower Seoul Sky', site:'https://www.seoulsky.lotteworld.com' },
    { n:'狎鷗亭 / 清潭洞', tag:'購物', d:'精品店與美容診所聚集的時尚街區。', hours:'約11:00–20:00(依店家而異)', mapQuery:'Apgujeong Rodeo Street Seoul' },
    { n:'奉恩寺', tag:'古蹟', d:'鬧區中的千年古剎,與摩天大樓形成強烈對比。', hours:'04:00–20:00', mapQuery:'Bongeunsa Temple Seoul', site:'https://www.bongeunsa.org' }
  ]},
  { id:'dongdaemun', name:'東大門', spots:[
    { n:'東大門設計廣場 DDP', tag:'建築', d:'扎哈·哈蒂設計的流線型建築,常有設計展覽。', hours:'10:00–20:00(部分展覽延長至22:00)', mapQuery:'Dongdaemun Design Plaza Seoul', site:'https://www.ddp.or.kr' },
  ...
  { id:'transit-hub', name:'交通轉乘點', spots:[
    { n:'KTX五松站(오송역)', tag:'交通', d:'清州機場入境後轉乘高鐵進首爾的關鍵車站,售票口兩側手扶梯可上樓月台。', hours:'首末班車依當日時刻表為準,約05:00–23:00', mapQuery:'Osong Station KTX Korea', site:'https://www.letskorail.com' },
    { n:'首爾高速巴士客運站', tag:'交通', d:'首爾市區長途巴士總站,可直接轉乘地鐵3、7、9號線。', hours:'24小時營業(各巴士公司售票時間不同)', mapQuery:'Seoul Express Bus Terminal' },
    { n:'首爾站(KTX/AREX)', tag:'交通', d:'首爾主要鐵路樞紐,可在此轉乘機場快線 AREX 直達仁川機場。', hours:'約05:30–24:00(依各路線末班車而定)', mapQuery:'Seoul Station Korea', site:'https://www.letskorail.com' }
  ]},
  { id:'airport', name:'機場', spots:[
    { n:'桃園國際機場', tag:'機場', d:'台灣主要國際機場,分為第一、第二航廈,兩航廈間有機場捷運與接駁車連接,並有機場捷運直達台北車站。', hours:'24小時開放(各航空公司櫃檯時間不同)', mapQuery:'Taoyuan International Airport', site:'https://www.taoyuan-airport.com' },
    { n:'仁川國際機場', tag:'機場', d:'韓國主要國際機場,首爾自由行最常使用的入境機場,分為第一、第二航廈,可搭機場快線 AREX 直達首爾站。', hours:'24小時開放(各航空公司櫃檯時間不同)', mapQuery:'Incheon International Airport', site:'https://www.airport.kr' },
    { n:'清州國際機場(CJJ)', tag:'機場', d:'韓國中部機場,可搭市區公車轉乘 KTX 五松站進首爾,適合搭配廉航行程入境。', hours:'24小時開放(各航空公司櫃檯時間不同)', mapQuery:'Cheongju International Airport', site:'https://www.airport.co.kr/cheongju/index.do' }
  ]}
];

const FOOD = [
  { n:'廣藏市場綠豆煎餅', tag:'小吃', d:'傳統市場內排隊名店,配一杯馬格利酒剛剛好。', hours:'09:00–18:00(部分攤位提早收攤)', mapQuery:'Gwangjang Market Seoul', site:'https://www.gwangjangmarket.co.kr' },
  ...
  { n:'土俗村蔘雞湯', tag:'補湯', d:'景福宮附近的人蔘雞湯名店,常需排隊。', hours:'10:00–22:00', mapQuery:'Tosokchon Samgyetang Seoul', site:'http://www.tosokchon.com/main.php' },
  { n:'小小烤腸(소소막창)', tag:'烤腸', d:'漢南洞人氣烤腸店,必點大蔥烤腸與香脆烤豬皮,建議開門第一批入座避開排隊。', hours:'16:00–翌日01:00(建議開門即入座)', mapQuery:'Sosomakchang Seoul', site:'https://www.instagram.com/hannam_soso/'  },
  { n:'倫敦貝果 London Bagel Museum(安國店)', tag:'貝果', d:'安國排隊名店,招牌蔥乳酪貝果,建議營業前現場掃碼候位。', hours:'08:00–20:00(建議07:40–08:00現場候位)', mapQuery:'London Bagel Museum Anguk Seoul', site:'https://www.instagram.com/london.bagel.museum/' },
  { n:'Cafe Onion 安國店', tag:'咖啡', d:'韓屋風格麵包咖啡廳,招牌雪山麵包與鹹奶油可頌。', hours:'07:00–22:00(依店家公告調整)', mapQuery:'Cafe Onion Anguk Seoul', site:'https://www.instagram.com/cafe.onion' },
  { n:'三清洞手工麵疙瘩(삼청동수제비)', tag:'麵食', d:'米其林畢比登推薦名店,Q彈麵片配小魚干高湯,可加點海鮮蔥餅。', hours:'11:00–21:00(依店家公告調整)', mapQuery:'Samcheongdong Sujebi Seoul', site:'https://www.xn--2q1bp1re1b2wb9ypllh.kr/'  },
  ...
  { n:'豬腳小姐 Myth Jokbal(弘大總店)', tag:'豬腳', d:'必點蒜味豬腳,隨餐附贈蒜辣刀削麵湯底與生菜沙拉。', hours:'16:00–翌日02:00(依店家而異)', mapQuery:'Myth Jokbal Hongdae Seoul', site:'https://www.instagram.com/mythjokbalhk/' },
  ...
  { n:'Goobne 炸雞(外送)', tag:'炸雞', d:'韓國人氣烤雞連鎖品牌,口味較清爽,適合漢江野餐外送。', hours:'依門市而異,約11:00–24:00', mapQuery:'Goobne Chicken Seoul', site:'hhttps://www.goobne.co.kr/main' },
  { n:'PURADAK CHICKEN(푸라닭치킨)', tag:'炸雞', d:'韓國人氣連鎖炸雞品牌,採獨創「烤炸」雙重工法,外皮酥脆內裡多汁,招牌黑蒜炸雞(블랙알리오)與辣椒美乃滋炸雞是必點,包裝也走質感路線。', hours:'依門市而異,建議出發前於地圖 App 確認最近分店營業時間', mapQuery:'PURADAK CHICKEN Seoul', site:'https://puradakchicken.com/main/'  },
  { n:'東大門獵奇辣炒年糕(동대문엽기떡볶)', tag:'年糕', d:'韓國最知名的極辣炒年糕連鎖品牌，主打大盆裝，適合多人分享（建議至少3人以上食用）。', hours:'依00:30–06:00, 11:30–00:00', mapQuery:'동대문엽기떡볶이 동대문본점', site:'https://www.yupdduk.com/' }  
];
...
const PACKING = [
  { category:'證件與金錢', items:['護照(效期6個月以上)','護照影本 / 電子檔備份','身分證/健保卡','機票、住宿訂單','韓幣現金','信用卡(記得開通海外交易)','旅遊保險證明'] },
  { category:'電子用品', items:['手機','充電頭','充電線','行動電源','轉接頭(韓國為 220V)','SIM卡 / Wi-Fi 分享器','記憶卡','電池','腳架','運動相機','相機與充電器'] },
  { category:'衣物', items:['依天數準備的上衣、褲子','保暖外套(依季節)','舒適好走的鞋子','襪子、內衣褲','睡衣'] },
  { category:'保養與盥洗', items:['防曬乳','乳液','指甲刀','防蚊液','濕紙巾/衛生紙','衛生棉','酒精','個人保養品(小罐分裝)','牙刷牙膏','化妝品 / 卸妝水/卸妝乳','牙線棒/棉花棒','太陽眼鏡','隱形眼鏡 / 眼鏡'] },
  { category:'藥品', items:['個人常備藥','OK蹦','感冒藥','頭痛藥','暈車藥','腸胃藥','酸痛貼布','個人處方藥(建議附英文診斷書)'] },
  { category:'其他', items:['環保購物袋(逛市場好用)','塑膠袋/夾鏈袋','雨傘或雨衣','行李秤','轉換插座延長線','筆記本或旅遊清單'] }
];
